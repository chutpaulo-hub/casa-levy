...
const SacoBlend = ({ blend, gram, moagem, isReserva = false, loteNome = "", loteNotas = "" }) => {
  ...
  const torra = isReserva ? "EDICAO LIMITADA" : (blend ? blend.torra : "");
...
const BuyBox = ({ blend, openModal }) => {
  ...
  const moagens = [
    { id: "grao", label: "Em grao", desc: "Para quem tem moedor" },
    { id: "espresso", label: "Moido para espresso", desc: "Moagem fina" },
    { id: "coado", label: "Moido para coado", desc: "V60, Chemex, Hario" },
    { id: "italiana", label: "Moido para italiana", desc: "Moka" },
  ];
  ...
  return (
    <section className="sec-dark pad-sec">
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        ...
        <FadeIn>
          <p style={{ fontFamily: "'Lora', serif", fontSize: 17, lineHeight: 1.9, color: COLORS.creme, opacity: 0.8, marginBottom: 32 }}>Cafe e a primeira coisa que a gente faz. E o que reune a casa antes do mundo comecar. E a desculpa para conversar, o pretexto para parar, o gesto que sustenta o trabalho e a tarde de domingo.</p>
          ...
          <button className="btn-text" onClick={() => nav("casa")}>Conheca nossa historia</button>
        </FadeIn>
      </div>
    </section>
  );
...
function Historia({ nav }) {
  const pessoas = [
    ...
    { gen: "A segunda geracao", nome: "Renato Levy", anos: "", texto: "Aprendeu o oficio observando o pai. E o coracao e a cara da Casa Levy. Quem decide os blends. Quem garante que cada saca que entra na torrefacao saia com a assinatura da casa. A continuidade do que o Rico comecou, agora com metodo, escala e a vontade de fazer o melhor cafe possivel." },
    { gen: "A terceira geracao", nome: "Paulo Chut", anos: "", texto: "Sobrinho-neto e apaixonado confesso por cafe, o tipo que toma xicaras sem parar e ainda acha que a proxima vai ser a melhor. Para Paulo, trabalhar com cafe nao e uma escolha racional. E a unica forma que faz sentido de honrar o avo Rico e transformar obsessao em algo real. Cuida da marca, da narrativa, e de garantir que cada caixa carregue nao so cafe, mas o ritual que o Rico ensinou." },
  ];
  return (
    <section className="sec-light pad-sec">
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <FadeIn style={{ textAlign: "center", marginTop: 80 }}>
          ...
          <button className="btn-text" style={{ color: COLORS.caramelo, borderBottomColor: COLORS.caramelo }} onClick={() => nav("casa")}>A historia completa</button>
        </FadeIn>
      </div>
    </section>
  );
    ...
    <section className="sec-deep pad-sec" style={{ textAlign: "center" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        <FadeIn>
          ...
          <p style={{ fontFamily: "'Lora', serif", fontSize: 17, lineHeight: 1.95, color: COLORS.creme, opacity: 0.8, marginBottom: 24 }}>Microlotes especiais em homenagem ao avo Menahem. Edicao limitada, numerada a mao, com a historia completa do produtor.</p>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px,1fr))", gap: 60, marginBottom: 64 }}>
          ...
          <div>
            ...
            {["Os Blends","Reserva Rico","Utensilios","A Cartilha","A Casa"].map((l, i) => (
          ...
          <div>
            ...
            {["Como funciona a assinatura","Frete e entrega","Trocas e devolucoes","Fale com a casa","FAQ"].map((l, i) => (
              <div key={i} style={{ marginBottom: 12 }}>
            ...
            <div style={{ marginTop: 24, padding: "16px", border: "0.5px solid " + COLORS.latao + "40" }}>
              ...
              <button onClick={() => nav("clube")} style={{ fontFamily: "'Lora', serif", fontSize: 13, color: COLORS.creme, opacity: 0.7, background: "none", border: "none", cursor: "pointer", padding: 0, lineHeight: 1.6 }}>Como funciona a assinatura e os beneficios exclusivos</button>
            </div>
          </div>
          <div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {["Politica de privacidade","Termos","Instagram"].map((l, i) => (
    ...
    <div className="cl-site sec-light" style={{ paddingTop: 80 }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 60px" }}>
        ...
        {[
          ...
          { n: "04", titulo: "Reserva Rico apos 6 meses", desc: "Quem completa 6 meses de assinatura recebe um lote da Reserva Rico escolhido pelo Renato. Um presente da casa para quem ficou." },
...
function PageReserva({ nav, openModal }) {
  const lotes = [
    ...
    { nome: "Reserva Rio", sub: "A patria que ele escolheu", fazenda: "Fazenda Cambuhy, Alta Mogiana", proc: "Honey", notas: "frutas tropicais · caju · mel", historia: "O Rio foi onde o Rico fincou raizes, criou familia e construiu tudo. E a patria que ele escolheu, e o cafe que ele mais amou tomar." },
  ];
  return (
    <div className="cl-site" style={{ paddingTop: 80 }}>
      <section style={{ background: "#1A0E0A", padding: "80px 60px", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'Lora', serif", fontSize: 17, lineHeight: 1.9, color: COLORS.creme, opacity: 0.75, maxWidth: 600, margin: "0 auto 24px" }}>Microlotes especiais numerados a mao, em homenagem ao avo Menahem. Disponivel avulso por R$ 99. Assinantes tem acesso antecipado a cada novo lote e, apos 6 meses de assinatura, o Renato escolhe um lote especial e envia de presente.</p>
...
function PageCartilha({ nav }) {
  const niveis = ["Esta comecando","Ja entendeu","Quer ir fundo"];
  const [ativo, setAtivo] = useState(0);
  const [artigoAberto, setArtigoAberto] = useState(null);

  const artigos = [
    [
      { titulo: "O que e cafe especial?", desc: "A diferenca entre o que voce toma e o que voce poderia tomar", tempo: "4 min", conteudo: "Cafe especial e uma classificacao tecnica, nao um rotulo de marketing. Para receber essa denominacao, um cafe precisa atingir no minimo 80 pontos em uma escala de 100 definida pela Specialty Coffee Association (SCA). A avaliacao e feita por profissionais certificados chamados Q-graders, que analisam atributos como aroma, acidez, corpo, docura, equilibrio e ausencia de defeitos.\n\nO que diferencia um cafe especial do cafe comum comeca antes da torra, na fazenda. Graos especiais sao colhidos seletivamente, no ponto exato de maturacao. Isso exige mais trabalho e resulta em menor volume, mas o impacto na xicara e significativo.\n\nCafes comuns sao, em geral, blends de graos de multiplas origens e safras, torrados escuro para uniformizar o sabor e mascarar defeitos. Cafes especiais preservam as caracteristicas do terroir, da altitude, da variedade botanica e do processamento. O resultado e um cafe com identidade.\n\nNa Casa Levy, todos os blends sao compostos exclusivamente por graos com pontuacao acima de 80 pontos. A Reserva Rico vai alem, com microlotes que alcancam pontuacoes acima de 85." },
      { titulo: "A diferenca entre torras", desc: "Por que o mesmo grao e outro cafe conforme a torra", tempo: "5 min", conteudo: "A torra e uma das etapas mais decisivas na cadeia do cafe. E ela que transforma os compostos quimicos do grao verde em aroma, sabor e corpo. O mesmo grao, submetido a torras diferentes, produz bebidas completamente distintas.\n\nDurante o processo, o grao passa por reacoes de Maillard e caramelizacao, desenvolvendo centenas de compostos aromaticos. A temperatura e o tempo de torra determinam quais compostos sao preservados e quais sao transformados ou eliminados.\n\nTorra clara, utilizada no Casa Horizonte, e interrompida antes ou logo apos o primeiro crack, entre 196C e 205C. Preserva mais acidez, florais e frutas, refletindo com fidelidade as caracteristicas de origem do grao. E a preferida para metodos de coado manual.\n\nTorra media, usada no Casa Equilibrio, equilibra acidez e docura. Os acucares estao mais desenvolvidos, o corpo e mais presente e o perfil aromatico e mais redondo. Funciona bem em espresso e em coado.\n\nTorra escura, presente no Casa Original, leva o grao alem do segundo crack, acima de 225C. A acidez cede espaco ao amargor controlado, ao corpo denso e ao caramelo. E a torra classica do espresso italiano e da cafeteira moka.\n\nNao existe torra melhor ou pior. Existe torra adequada ao metodo e ao paladar de cada pessoa." },
      { titulo: "Como fazer um coado decente", desc: "Com o que voce ja tem em casa", tempo: "3 min", conteudo: "Voce nao precisa de equipamento especial para fazer um coado bom. Precisa de tres coisas: cafe fresco, agua quente na temperatura certa e atencao ao processo.\n\nTemperatura da agua: o ideal e entre 90C e 96C. Agua fervendo demais superextrai o cafe e traz amargor. Se nao tiver termometro, ferva a agua e aguarde 30 segundos antes de usar.\n\nProporcao: uma boa referencia e 1 grama de cafe para cada 15 ml de agua. Para uma xicara de 200 ml, use cerca de 13 gramas de cafe.\n\nMoagem: para coado, a moagem deve ser media, parecida com areia grossa. Moagem muito fina entope o filtro e deixa o cafe amargo. Muito grossa e o cafe fica aguado.\n\nO processo: umedeca o filtro com agua quente antes de colocar o cafe. Isso elimina o gosto de papel e aquece o recipiente. Despeje a primeira quantidade de agua, o suficiente para umedecer todo o po, e aguarde 30 segundos. Esse e o bloom, etapa em que os gases liberados pelo cafe fresco escapam. Depois, despeje o restante da agua em movimentos circulares lentos e constantes.\n\nTempo total de extracao: entre 3 e 4 minutos. Abaixo disso, o cafe esta subextraido e acido. Acima, pode ficar amargo." },
    ],
    [
      { titulo: "Espresso ou coado: qual e seu?", desc: "Um guia honesto para descobrir seu metodo", tempo: "6 min", conteudo: "A escolha entre espresso e coado nao e questao de gosto apenas. Envolve estilo de vida, equipamento disponivel e o que voce espera da bebida.\n\nO espresso e uma extracao sob pressao, entre 8 e 10 bar, em 25 a 30 segundos, com dose de 18 a 20 gramas de cafe para um resultado de 36 a 40 ml. O resultado e concentrado, com crema, corpo denso e intensidade elevada. E a base do cappuccino, do flat white e de qualquer bebida com leite.\n\nPara fazer espresso em casa com qualidade, voce precisa de uma maquina com bomba de pressao adequada e, idealmente, de um moedor capaz de ajuste fino de moagem. Sem o moedor certo, mesmo a melhor maquina produz resultados inconsistentes.\n\nO coado, em qualquer de suas variacoes como V60, Chemex, Hario ou coador de pano, e uma extracao por percolacao. A agua passa pelo cafe por gravidade, sem pressao. O resultado e uma bebida mais clara, com acidez mais evidente, florais e complexidade aromatica. E o metodo que melhor expressa as caracteristicas de origem de um cafe especial.\n\nPara o coado, o investimento e menor. Um coador de ceramica, filtros e uma chaleira de bico fino ja sao suficientes para resultados consistentes.\n\nSe voce aprecia a intensidade e bebe o cafe puro ou com leite, o espresso e seu metodo. Se voce gosta de explorar nuances, aroma e tem paciencia para o processo, o coado vai surpreender." },
      { titulo: "Moagem: o fator que mais importa", desc: "Por que o moedor importa mais que a maquina", tempo: "7 min", conteudo: "No mundo do cafe, ha um consenso entre profissionais: o moedor e o equipamento mais importante da sua bancada. Mais do que a maquina de espresso, mais do que o metodo de coado.\n\nO motivo e tecnico. A extracao do cafe depende da superficie de contato entre o po e a agua. Graos moidos de forma irregular, com particulas de tamanhos diferentes, extraem de forma desigual. As particulas menores superextraem e trazem amargor. As particulas maiores subextraem e trazem acidez indesejada. O resultado e um cafe desequilibrado, independentemente da qualidade do grao ou do metodo usado.\n\nUm bom moedor produz particulas uniformes. Isso garante que toda a superficie do cafe extraia no mesmo ritmo, resultando em equilibrio e clareza na xicara.\n\nMoedores de disco conico sao superiores aos de lamina, que funcionam como liquidificadores e trituram o cafe de forma aleatoria. Moedores de disco plano sao os preferidos para espresso, por produzirem distribuicao mais uniforme em moagens finas.\n\nPara coado, um moedor manual conico de qualidade ja entrega resultados excelentes e custa a partir de R$ 200. Para espresso, o investimento precisa ser maior, pois a moagem fina exige precisao e consistencia.\n\nSe voce usa cafe pre-moido, saiba que o processo de oxidacao comeca imediatamente apos a moagem. Em 15 minutos, parte dos compostos aromaticos ja se dissipou. Moer na hora e a diferenca entre um cafe vivo e um cafe plano." },
      { titulo: "Como o Renato faz o coado de manha", desc: "A receita da casa, com notas de cada etapa", tempo: "4 min", conteudo: "Renato torra cafe toda semana e bebe cafe todo dia. A receita que ele usa de manha nao e sofisticada. E consistente.\n\nEquipamento: coador de ceramica V60, filtro de papel branqueado, chaleira de bico fino, balanca e termometro.\n\nCafe: Casa Equilibrio, moido na hora em moagem media. 15 gramas para 225 ml de agua.\n\nTemperatura da agua: 93C. Renato ferve a agua e aguarda 45 segundos antes de usar.\n\nPrimeira etapa e umedecer o filtro com agua quente e descartar. Isso elimina o residuo de papel e aquece o coador.\n\nSegunda etapa e o bloom. Renato despeja 30 ml de agua sobre o cafe em movimento circular e aguarda 35 segundos. O cafe fresco libera CO2 nesse momento. Se nao houver borbulhamento visivel, o cafe nao e tao fresco quanto deveria ser.\n\nTerceira etapa e a extracao principal. Ele despeja o restante da agua em duas etapas, em movimentos circulares lentos do centro para as bordas, evitando a parede do filtro. O fluxo e constante e controlado.\n\nTempo total: 3 minutos e 20 segundos do inicio ao fim da extracao.\n\nO resultado e uma xicara limpa, com acidez suave, caramelo presente e corpo medio. Renato bebe sem acucar. Mas isso, ele diz, e escolha de cada um." },
    ],
    [
      { titulo: "Processamentos: natural, lavado e honey", desc: "Como o processamento na fazenda cria sabores diferentes", tempo: "8 min", conteudo: "O processamento e a etapa entre a colheita do fruto do cafe e a obtencao do grao seco, pronto para a torra. E uma das variaveis que mais impacta o perfil sensorial da bebida, e frequentemente mais do que a propria variedade botanica.\n\nO processamento natural, tambem chamado de dry process, e o mais antigo. O fruto inteiro e seco ao sol, com a polpa ainda envolvendo o grao. O processo dura entre 3 e 6 semanas. Durante esse periodo, os acucares da polpa fermentam e sao absorvidos pelo grao, resultando em perfis com notas intensas de frutas tropicais, vinosas e corpo elevado. E o processamento usado na Reserva Alexandria.\n\nO processamento lavado, ou washed, remove a polpa do grao antes da secagem. O resultado e um cafe mais limpo, com acidez mais evidente e perfil aromatico que reflete com maior fidelidade a variedade botanica e a altitude da fazenda. E o processamento preferido para expressar terroir.\n\nO processamento honey, desenvolvido na Costa Rica e amplamente adotado no Brasil, e intermediario. Remove a casca do fruto, mas mantem parte ou toda a mucilagem sobre o grao durante a secagem. A quantidade de mucilagem preservada define subtipos como yellow honey, red honey e black honey, em ordem crescente de docura e corpo. O Casa Equilibrio utiliza graos com processamento honey.\n\nEntender o processamento ajuda a antecipar o perfil da bebida antes mesmo de provar. Natural aponta para frutas e corpo. Lavado aponta para clareza e acidez. Honey aponta para equilibrio e docura." },
      { titulo: "Extraindo um espresso perfeito", desc: "Os parametros que voce precisa entender", tempo: "10 min", conteudo: "O espresso e o metodo com menor margem de erro. Uma variacao pequena em qualquer parametro altera significativamente o resultado na xicara. Entender as variaveis e o primeiro passo para extracoes consistentes.\n\nDose: a quantidade de cafe no portafiltro, normalmente entre 16 e 20 gramas, dependendo do tamanho do cesto. A dose determina a resistencia que o cafe oferece a passagem da agua.\n\nYield: a quantidade de liquido extraido, medida em gramas. A proporcao de extracao, chamada de ratio, e normalmente expressa como 1:2, ou seja, 18 gramas de cafe para 36 gramas de liquido. Ratios mais altos resultam em espressos mais longos e menos intensos.\n\nTempo de extracao: entre 25 e 30 segundos para uma extracao equilibrada. Abaixo de 20 segundos, o cafe esta subextraido, com acidez pronunciada e falta de docura. Acima de 35 segundos, esta superextraido, com amargor dominante.\n\nMoagem: e a principal variavel de ajuste. Moagem mais fina aumenta a resistencia, desacelera a extracao e aumenta o tempo. Moagem mais grossa reduz a resistencia e acelera a extracao.\n\nTemperatura: entre 90C e 96C. Cafes de torra escura extraem melhor em temperaturas menores, ao redor de 90C. Cafes de torra clara exigem temperaturas mais altas para desenvolver adequadamente.\n\nPressao: 9 bar e o padrao estabelecido pela tradicao italiana. Algumas maquinas permitem ajuste de pressao, abrindo espaco para experimentacao.\n\nO espresso perfeito nao existe como ponto fixo. Existe como equilibrio entre acidez, docura e amargor, ajustado ao paladar de quem bebe." },
      { titulo: "Era do Rico essa mania de cardamomo no cafe", desc: "A heranca egipcia e o que ela tem a ensinar", tempo: "5 min", conteudo: "Na Alexandria dos anos 1940, o cafe nao era bebido sozinho. Era servido com cardamomo, as vezes com agua de rosas, sempre em xicaras pequenas e sem filtro. Era o cafe arabe, o qahwa, e era parte de qualquer recepcao, de qualquer conversa, de qualquer momento de hospitalidade.\n\nMenahem Levy cresceu nesse ritual. Quando chegou ao Brasil, trouxe o habito. Nao como regra, mas como possibilidade. O cardamomo aparecia na sua xicara em dias especificos, sem metodo definido, apenas pela memoria do que tinha sido normal para ele.\n\nO cardamomo pertence a familia do gengibre e e amplamente utilizado na culinaria indiana e arabe. No cafe, ele adiciona notas citricas e levemente mentoladas, que contrabalancam a amargura e ampliam a percepcao de docura. Do ponto de vista quimico, os oleos essenciais do cardamomo, em especial o cineol e o limoneno, interagem com os compostos aromaticos do cafe e criam um perfil sensorial distinto.\n\nA tecnica mais comum e adicionar uma ou duas sementes de cardamomo levemente amassadas ao po de cafe antes da extracao. Em cafeteiras de filtro ou moka, o resultado e sutil e integrado. Em coados, o aroma e mais pronunciado.\n\nNao e uma preparacao para todo dia. Mas e uma preparacao que conta uma historia. E, as vezes, isso e suficiente para fazer uma xicara valer mais do que o cafe que ela contem." },
    ],
  ];
    ...
    <div className="cl-site sec-light" style={{ paddingTop: 80 }}>
      <div style={{ background: COLORS.cremeBg, padding: "80px 60px", minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <button className="btn-secondary-dark" onClick={() => openModal("aviso de novidades da loja")}>Me avisa quando chegar</button>
        </div>
      </div>
      <Footer nav={nav} openModal={openModal}/>
    </div>
    ...
    <div className="cl-site" style={{ minHeight: "100vh" }}>
      ...
      {menuOpen && (
        <div className="mob-menu">
          <button onClick={() => setMenuOpen(false)} style={{ position: "absolute", top: 24, right: 24, background: "none", border: "none", cursor: "pointer", color: COLORS.creme, fontFamily: "'Cormorant Garamond', serif", fontSize: 28 }}>x</button>
          {navLinks.map((l, i) => (
